...
import * as tiposSensor from "./schema/tipos-sensor"
import * as tiposEquipamento from "./schema/tipos-equipamento"
...
export const db = drizzle(client, {
  schema: { ...clientes, ...usuarios, ...edificacoes, ...sensores, ...leituras, ...documentos, ...notificacoesConfig, ...notificacoesRegras, ...notificacoesRegraDestinatarios, ...notificacoes, ...planosDados, ...equipamentos, ...tiposSensor, ...tiposEquipamento },
})
